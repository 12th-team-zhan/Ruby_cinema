...
export default class extends Controller {
  ...
  changeLink(amount) {
    this.nextTarget.href = `/ticketing/select_seats?showtimeid=${this.element.dataset.id}&amount=${amount}&regularAmount=${this.regularAmountTarget.value}&concessionAmount=${this.concessionAmountTarget.value}&elderlyAmount=${this.elderlyAmountTarget.value}&disabilityAmount=${this.disabilityAmountTarget.value}`;
  }
}
